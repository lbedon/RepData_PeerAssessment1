...
geom_histogram(data=stepsperday,aes(SumDay),binwidth=1000,colour=rgb(.5,.25,.75,.75),fill=rgb(.5,.25,.75,.5))+

##histogramm with the filled data  
geom_histogram(data=stepsperdayfilled,aes(SumDay),binwidth=1000,colour=rgb(.25,.75,.05,.75),fill=rgb(.25,.75,.05,.5))+
scale_x_continuous(name="Total number of steps taken each day \n Bin's width = 1000 ",breaks=seq(0,24000,2000),minor_breaks = seq(1000,24000,2000))+
...
```{r}
ggplot()+
geom_line(data=results,aes(x=x,y=z,group=y,colour=y),colour=rgb(.5,.25,.75,.75))+
geom_point(data=results,aes(x=x,y=z,group=y,colour=y,shape=y),size=4,alpha=.5)+
#geom_point(data=results,aes(x=x,y=z,group=y,colour=y),size=4, shape=23)+
...
ggplot()+
geom_line(data=stepsperday,aes(x=Date,y=SumDay),color=rgb(.5,.25,.75,.75))+
